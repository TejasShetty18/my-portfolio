...
//     return (
//         <section className="py-16 max-w-4xl mx-auto px-6" id="certifications">
...
//                                             {/* Provider Logo using Shadcn Avatar */}
//                                             <Avatar className="h-12 w-12 border-2 border-background shadow-sm">
//                                                 {/* You can add real logos here: <AvatarImage src="/logos/google.png" /> */}
